...
class SupervisorRegistrationScreen extends StatelessWidget {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text(
            'إنشاء حساب مشرف', // تم تحديث العنوان
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              // **أيقونة الدور (المشرف) فوق الحقل الأول**
              const Icon(
                Icons.person_pin_outlined, // أيقونة المشرف التعليمي
                size: 60,
                color: Color(0xFF0D47A1),
              ),
